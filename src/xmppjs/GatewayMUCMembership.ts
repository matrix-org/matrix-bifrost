...
export class GatewayMUCMembership {
  ...
  public getMemberByAnonJid<G extends IGatewayMember>(
    chatName: string,
    anonJid: string,
  ): G | undefined {
    return Array.from(this.getMembers(chatName)).find(
      (user) => user.anonymousJid.toString() === anonJid,
    ) as G;
  }

  public getMatrixMemberByMatrixId(
    chatName: string,
    matrixId: string,
  ): IGatewayMemberMatrix | undefined {
  ...
  public getXmppMemberByDevice(
    chatName: string,
    realJid: string | JID,
  ): IGatewayMemberXmpp | undefined {
  ...
  public getXmppMemberByRealJid(
    ...
    const member = this.getXmppMembers(chatName).find(
      (user) => user.realJid.toString() === strippedJid,
    );
    return member;
  }

  public getXmppMemberByMatrixId(
    chatName: string,
    matrixId: string,
  ): IGatewayMemberXmpp | undefined {
  ...
  public getXmppMembers(chatName: string): IGatewayMemberXmpp[] {
    return Array.from(this.getMembers(chatName)).filter(
      (s) => s.type === "xmpp",

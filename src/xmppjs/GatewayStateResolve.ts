...
import { IStza, PresenceAffiliation, PresenceRole, StzaPresenceItem } from "./Stanzas";
...
export class GatewayStateResolve {
  static resolveMatrixStateToXMPP(
    chatName: string,
    members: GatewayMUCMembership,
    ...
    if (membership === "join") {
      ...
      if (existingMember) {
        ...
        presenceSelf.statusCodes.add(
          membership === "leave" ? XMPPStatusCode.SelfKicked : XMPPStatusCode.SelfBanned,
        );

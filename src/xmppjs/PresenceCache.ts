...
export class PresenceCache {
  ...
  public add(stanza: xml.Element): IPresenceDelta | undefined {
    ...
    // TODO: Handle technical removals.
    // const isTechnicalRemoval = !!(
    //   mucUser && mucUser.getChildByAttr("code", XMPPStatusCode.SelfKickedTechnical)
    // );
    const newUser = !this.presence.get(from.toString());
    const currentPresence =
      this.presence.get(from.toString()) ||
      ({
